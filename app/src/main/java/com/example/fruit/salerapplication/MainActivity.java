...
import com.example.fruit.salerapplication.commontool.SalerService;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void initView () {
        ...
        backIntent = new Intent(this, SalerService.class);
        ...
        public void onClick(View v) {
            switch (index) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Intent intent = new Intent(MainActivity.this, ScanIn.class);
